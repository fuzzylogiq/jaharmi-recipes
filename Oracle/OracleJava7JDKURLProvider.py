...
# URL to find the Java 7 JDK download
BASE_URL = "".join([
...
class OracleJava7JDKURLProvider(Processor):
    ...
    output_variables = {
        "url": {
            "description": "URL to the latest Oracle Java 7 JDK release.",
        },
        "request_headers": {
            "description": "Additional headers for the Oralce Java 7 JDK download.",
        },
    }
    description = __doc__
